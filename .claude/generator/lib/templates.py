...
# Approval gate instructions for Design Bridge specifically
APPROVAL_GATE_INSTRUCTIONS = """
### ⚠️ Human-in-the-Loop Approval Gate (Design Bridge Only)

**CRITICAL**: Before proceeding with compression, verify user approval:
...
The Solution Architect has completed the design, but you have not yet reviewed and approved it.
