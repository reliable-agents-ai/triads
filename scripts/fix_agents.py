...
class AgentFixer:
    ...
    def check_file(self, file_path: Path) -> List[str]:
        ...
        if frontmatter is None:
            ...
            required_fields = ['name', 'triad', 'role']
    ...
    def fix_file(self, file_path: Path, issues: List[str]) -> bool:
        ...
        if 'generated_by' not in new_frontmatter:
            ...
            new_frontmatter['generator_version'] = '0.3.0+'
    ...
    def scan(self) -> None:
        ...
        for file_path in agent_files:
            ...
            if not self.is_generated_file(file_path):
...
def main():
    ...
    # Initialize fixer
    fixer = AgentFixer(project_root=args.project_root)
