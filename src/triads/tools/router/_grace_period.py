...
from ._timestamp_utils import utc_now_aware, utc_now_iso
...
class GracePeriodChecker:
    ...
    def __init__(
        self,
        state_manager: _RouterStateManager,
        grace_turns: int = 5,
        grace_minutes: int = 8,
    ):
        """
        ...
        Args:
            state_manager: _RouterStateManager instance
