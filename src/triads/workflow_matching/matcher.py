"""Workflow gap detection using semantic keyword matching.

This module implements the WorkflowMatcher class for identifying workflow types
from user messages using keyword-based matching with confidence scoring.
...
class WorkflowMatcher:
    ...
    def __init__(self, keyword_library: Dict[str, Set[str]]):
